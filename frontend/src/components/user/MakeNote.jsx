      ...
      <div className="bg-gray-300 px-2 py-2 rounded-2xl">
        <div className="bg-gray-200 px-8 py-8 rounded-2xl relative">
          ...
          {user ? (
            <div className="flex-col font-raleway text-gray-600">
              ...
              <form className="grid grid-cols-1 gap-10" onSubmit={handleSubmit}>
                ...
                <div className="w-full flex justify-between">
                  ...
                  <button
                    className="sm:w-36 md:w-44 sm:h-12 md:h-16 rounded-md bg-[#02343F] text-gray-100 md:text-2xl sm:text-xl hover:bg-[#F0EDCC] hover:text-black"
                    type="submit"
                  >
                    Save Note
                  </button>
            ...
            <div className="flex w-full justify-center font-raleway text-gray-600 pt-32">
              <div>
                ...
                <div className="flex w-full justify-center pt-10">
                  <button
                    className="w-52 h-16 rounded-md bg-[#02343F] text-gray-600 hover:bg-[#F0EDCC] hover:text-black text-3xl flex justify-center items-center gap-4"
